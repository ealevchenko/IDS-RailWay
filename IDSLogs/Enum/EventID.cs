...
namespace IDSLogs.Enum
{
    public enum eventID : int
    {
        ...
        EFIDS_Arhiv = 3150,         // Библиотека базы данных IDS_Arhiv
        IDS_Directory = 3300,       // Сервис справочников ИДС (старый)
        IDS_Direct = 3301,          // Сервис справочников ИДС (новый)
        IDS_Arhiv = 3350,           // Сервис справочников ИДС (старый)
