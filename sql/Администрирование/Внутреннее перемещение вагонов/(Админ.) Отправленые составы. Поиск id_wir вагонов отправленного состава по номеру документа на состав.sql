...
SELECT TOP (1000) [id]
  ...
  where [position_outgoing] is not null AND [id_outgoing] in (select id FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingSostav] where [num_doc]=@num_doc)
  ...
  where [id_outgoing_car] in (select id FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars]  where [position_outgoing] is not null AND [id_outgoing] in (select id FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingSostav] where [num_doc]=@num_doc))
