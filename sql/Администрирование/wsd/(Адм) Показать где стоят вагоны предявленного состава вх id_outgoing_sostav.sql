...
SELECT [id]
  ...
  where [id_outgoing_car]  in (Select id FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing] = @id_sostav)
...
SELECT [id]
  ...
  where [close] is null and [id_wagon_internal_routes] in (select id FROM [KRR-PA-CNT-Railway].[IDS].[WagonInternalRoutes] where [id_outgoing_car]  in (Select id FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing] = @id_sostav))