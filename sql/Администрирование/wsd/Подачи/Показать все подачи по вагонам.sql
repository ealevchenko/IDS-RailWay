...
SELECT TOP (1000) [id]
  ...
  where [id_wagon_internal_routes] in (select top(1) id FROM [KRR-PA-CNT-Railway].[IDS].[WagonInternalRoutes] where num = @num order by 1 desc)
  order by 1 desc
 ...
 SELECT TOP (1000) [id]
  ...
  where [id] in (select [id_filing] FROM [KRR-PA-CNT-Railway].[IDS].[WagonInternalMovement] where [id_wagon_internal_routes] in (select top(1) id FROM [KRR-PA-CNT-Railway].[IDS].[WagonInternalRoutes] where num = @num order by 1 desc))
  order by 1 desc
