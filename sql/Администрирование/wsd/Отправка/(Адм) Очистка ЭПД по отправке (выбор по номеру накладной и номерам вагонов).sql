...
SELECT [id]
  ...
  where [id_outgoing]=252448
  -- and [num_doc] != '89866297'
  and num =63664874 

 -- UPDATE [IDS].[Outgoing_UZ_Vagon]
 -- SET [id_document] = null
	--WHERE id in (SELECT [id_outgoing_uz_vagon] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231730 and num in (52686110))

 --UPDATE [IDS].[OutgoingCars]
 --  SET [num_doc] = null
 --WHERE id in (SELECT [id] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231730 and num in (52686110))
...
--231969
  SELECT [id] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=252448 and num in (63664874)
  SELECT [id_outgoing_uz_vagon] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=252448 and num in (63664874)
