...
--231969
  SELECT [id] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231931 and num in (52686110)
  SELECT [id_outgoing_uz_vagon] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231931 and num in (52686110)
