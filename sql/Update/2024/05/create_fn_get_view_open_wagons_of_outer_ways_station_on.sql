...
/*
Скрипт [get_view_open_wagons_of_outer_ways_station_on]
Выборка всех доконца не принятых составов на указаную станцию 
(отображаются все вагоны с учетом принятых и возврата)
14-05-2024 Левченко Э. 
*/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_open_wagons_of_outer_ways_station_on]
 (
	@id_station_on int
 )
		RETURNS 
