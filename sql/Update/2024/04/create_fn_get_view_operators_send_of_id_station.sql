...
/****** Object:  UserDefinedFunction [IDS].[get_view_operators_send_of_id_station]    Script Date: 18.04.2024 11:18:15 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_operators_send_of_id_station]
 (
   @id_station int
 )
	RETURNS 
