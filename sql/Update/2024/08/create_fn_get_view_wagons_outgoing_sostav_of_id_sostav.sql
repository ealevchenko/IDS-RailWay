...
/****** Функция выборки вагонов по отправленому составу ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_wagons_outgoing_sostav_of_id_sostav]
 (
	@id_sostav int
 )
		RETURNS 
	...
	FROM [IDS].[OutgoingSostav] as out_sost
		...
		WHERE (out_sost.id =@id_sostav AND out_car.position_outgoing is not null)
