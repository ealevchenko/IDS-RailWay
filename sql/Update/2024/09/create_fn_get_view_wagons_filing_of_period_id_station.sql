...
/****** Script Date: 30.09.2024 11:40:17 
Ôóíêöèÿ âûáîğêè ïîäà÷ çà ïåğèîä ïî óêàçàííîé ñòàíöèè 
(îòîáğàæàåò âñå ïîäà÷è çà ïåğèîä èëè âñå íåçàêğûòûå çà îñòàëüíîå âğåìÿ)
******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_wagons_filing_of_period_id_station]
 (
	...
	FROM IDS.WagonFiling as wf 
		...
		--> Îïåğàöèÿ ïîäà÷è		
		LEFT JOIN IDS.WagonInternalOperation as wio_filing  ON wio_filing.[id] = wf.[id_wio]
