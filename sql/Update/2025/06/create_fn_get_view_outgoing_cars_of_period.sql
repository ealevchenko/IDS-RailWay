...
/****** Object:  UserDefinedFunction [IDS].[get_view_outgoing_cars_of_period]    Script Date: 06.06.2025 9:08:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_outgoing_cars_of_period]
 (
	@start datetime, 
	@stop datetime,
	@IsActs bit
	...
	[arrival_uz_vagon_tation_amkr_name_en] [nvarchar](50) NULL,
	...
	[arrival_uz_vagon_kol_os] [int] NULL,
	[arrival_uz_vagon_usl_tip] [nvarchar](10) NULL,
	[arrival_uz_vagon_date_rem_uz] [datetime] NULL,
	[arrival_uz_vagon_date_rem_vag] [datetime] NULL,
	...
	[arrival_uz_document_payer_arriva_name_en] [nvarchar](100) NULL,
	[arrival_uz_code_payer_local] [nvarchar](20) NULL,
	[arrival_uz_document_payer_local_name_ru] [nvarchar](100) NULL,
	[arrival_uz_document_payer_local_name_en] [nvarchar](100) NULL,
	[arrival_uz_tariff_contract] [money] NULL,
	[arrival_uz_calc_payer] [datetime] NULL,
	[arrival_uz_calc_payer_user] [nvarchar](50) NULL,
	...
	[arrival_uz_manual] [bit] NULL,
	[arrival_uz_date_otpr] [datetime] NULL,
	[arrival_uz_srok_end] [datetime] NULL,
	[arrival_uz_date_grpol] [datetime] NULL,
	[arrival_uz_date_pr] [datetime] NULL,
	[arrival_uz_date_vid] [datetime] NULL,
	[arrival_uz_IdActServices1] [int] NULL,
	[arrival_uz_NumActServices1] [nvarchar](50) NULL,
	[arrival_uz_IdActServices2] [int] NULL,
	[arrival_uz_NumActServices2] [nvarchar](50) NULL,
	[arrival_uz_IdActServices3] [int] NULL,
	[arrival_uz_NumActServices3] [nvarchar](50) NULL,
	[arrival_uz_Verification] [datetime] NULL,
	[arrival_uz_VerificationUser] [nvarchar](50) NULL,
	...
	[outgoing_car_create] [datetime] NOT NULL,
	[outgoing_car_create_user] [nvarchar](50) NOT NULL,
	...
	[outgoing_uz_vagon_condition_repairs] [bit] NULL,
	[outgoing_uz_vagon_arrival_id_wagons_rent] [int] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_id_operator] [int] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operators_ru] [nvarchar](100) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operators_en] [nvarchar](100) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operator_abbr_ru] [nvarchar](20) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operator_abbr_en] [nvarchar](20) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_start] [datetime] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_end] [datetime] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operator_paid] [bit] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_operator_color] [nvarchar](10) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_id_limiting] [int] NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_limiting_name_ru] [nvarchar](100) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_limiting_name_en] [nvarchar](100) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_limiting_abbr_ru] [nvarchar](30) NULL,
	[outgoing_uz_vagon_arrival_wagons_rent_limiting_abbr_en] [nvarchar](30) NULL,
	...
	[outgoing_uz_vagon_outgoing_wagons_rent_group_id_operator] [int] NULL,
	[outgoing_uz_vagon_outgoing_wagons_rent_group_operators_ru] [nvarchar](100) NULL,
	[outgoing_uz_vagon_outgoing_wagons_rent_group_operators_en] [nvarchar](100) NULL,
	[outgoing_uz_vagon_outgoing_wagons_rent_operator_group_abbr_ru] [nvarchar](20) NULL,
	[outgoing_uz_vagon_outgoing_wagons_rent_operator_group_abbr_en] [nvarchar](20) NULL,
	...
	[outgoing_uz_vagon_id_out_group] [int] NULL,
	[outgoing_uz_vagon_cargo_out_group_name_ru] [nvarchar](50) NULL,
	[outgoing_uz_vagon_cargo_out_group_name_en] [nvarchar](50) NULL,
	...
	[outgoing_uz_vagon_kol_conductor] [int] NULL,
	[outgoing_uz_vagon_create] [datetime] NULL,
	[outgoing_uz_vagon_create_user] [nvarchar](50) NULL,
	[outgoing_uz_vagon_change] [datetime] NULL,
	[outgoing_uz_vagon_change_user] [nvarchar](50) NULL,
	...
	[outgoing_uz_document_station_to_port] [bit] NULL,
	...
	[outgoing_uz_document_tariff_contract] [int] NULL,
	[outgoing_uz_document_calc_payer] [datetime] NULL,
	[outgoing_uz_document_calc_payer_user] [nvarchar](50) NULL,
	[outgoing_uz_document_num_list] [int] NULL,
	[outgoing_uz_document_date_list] [datetime] NULL,
	[outgoing_uz_document_Verification] [datetime] NULL,
	[outgoing_uz_document_VerificationUser] [nvarchar](50) NULL,
	[outgoing_uz_document_create] [datetime] NULL,
	[outgoing_uz_document_create_user] [nvarchar](50) NULL,
	[outgoing_uz_document_change] [datetime] NULL,
	[outgoing_uz_document_change_user] [nvarchar](50) NULL,
	...
	[wagon_usage_fee_derailment] [bit] NULL,
	[wagon_usage_fee_downtime] [int] NULL,
	[wagon_usage_fee_calc_time] [int] NULL,
	[wagon_usage_fee_calc_fee_amount] [money] NULL,
	[wagon_usage_fee_manual_time] [int] NULL,
	[wagon_usage_fee_manual_fee_amount] [money] NULL,
	[wagon_usage_fee_note] [nvarchar](100) NULL,
	[wagon_usage_fee_create] [datetime] NULL,
	[wagon_usage_fee_create_user] [nvarchar](50) NULL,
	[wagon_usage_fee_change] [datetime] NULL,
	[wagon_usage_fee_change_user] [nvarchar](50) NULL,
	...
	[outgoing_uz_vagon_pay_001] [bigint] NULL,
	[outgoing_uz_vagon_pay_add] [bigint] NULL
	)
	AS
	BEGIN
	...
	insert @view_wagons
		...
		--> Справочник Оператор вагона по отпрвавке
