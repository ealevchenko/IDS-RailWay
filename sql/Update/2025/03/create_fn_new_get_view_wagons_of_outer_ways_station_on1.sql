...
/****** Object:  UserDefinedFunction [IDS].[get_view_wagons_of_outer_ways_station_on]    Script Date: 10.03.2025 16:15:31 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_wagons_of_outer_ways_station_on1]
 (
	@id_station_on int
 )
		RETURNS 
	...
	[from_operation_name_ru] [nvarchar](50) NULL,
	[from_operation_name_en] [nvarchar](50) NULL,
	[from_busy] [bit] NULL,
	...
	[arrival_id_station] [int] NULL,
	[arrival_station_name_ru] [nvarchar](50) NULL,
	[arrival_station_name_en] [nvarchar](50) NULL,
	[arrival_station_abbr_ru] [nvarchar](50) NULL,
	[arrival_station_abbr_en] [nvarchar](50) NULL,
	[on_id_way] [int] NULL,
	[on_id_park] [int] NULL,
	...
	[on_operation_name_ru] [nvarchar](50) NULL,
	[on_operation_name_en] [nvarchar](50) NULL,
	[on_busy] [bit] NULL,
