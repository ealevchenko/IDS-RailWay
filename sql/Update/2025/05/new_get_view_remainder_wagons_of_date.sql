...
/****** Object:  UserDefinedFunction [IDS].[get_view_operating_balance_of_date]    Script Date: 29.05.2025 15:01:01 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_remainder_wagons_of_date]
 (
   @date datetime
 )
	RETURNS 
	...
	[arrival_uz_vagon_operators_wagons_group] [nvarchar](20) NULL,
	...
	[sap_incoming_supply_kod_r_10] [nvarchar](4) NULL,
	[operators_wagons_group] [nvarchar](20) NULL,
	[wagons_rent_id_operator] [int] NULL,
	[wagons_rent_operators_ru] [nvarchar](100) NULL,
	[wagons_rent_operators_en] [nvarchar](100) NULL,
	[wagons_rent_operator_abbr_ru] [nvarchar](20) NULL,
	[wagons_rent_operator_abbr_en] [nvarchar](20) NULL,
	[wagons_rent_start] [datetime] NULL,
	[wagons_rent_end] [datetime] NULL,
	[wagons_rent_operator_paid] [bit] NULL,
	[wagons_rent_operator_color] [nvarchar](10) NULL,
	[id_condition] [int] NULL,
	[condition_name_ru] [nvarchar](100) NULL,
	[condition_name_en] [nvarchar](100) NULL,
	[condition_abbr_ru] [nvarchar](20) NULL,
	[condition_abbr_en] [nvarchar](20) NULL,
	[condition_repairs] [bit] NULL,
	...
	[id_organization_service] [int] NULL,
	[organization_service_ru] [nvarchar](50) NULL,
	[organization_service_en] [nvarchar](50) NULL,
...
SELECT 
	...
	--> ПОДАЧИ последние
	Left JOIN [IDS].[WagonInternalMovement] as wim_unload ON wim_unload.id = (SELECT top(1) wim_f.[id] FROM [IDS].[WagonInternalMovement] as wim_f Left JOIN [IDS].[WagonFiling] as wf ON wf.id = wim_f.[id_filing]
