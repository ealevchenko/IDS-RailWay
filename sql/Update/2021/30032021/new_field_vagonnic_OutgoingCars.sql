...
/****** Object:  Table [IDS].[OutgoingCars]    Script Date: 30.03.2021 8:12:34 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [IDS].[OutgoingCars]  WITH CHECK ADD  CONSTRAINT [FK_OutgoingCars_Directory_Reason_Discrepancy] FOREIGN KEY([id_reason_discrepancy_uz])
REFERENCES [IDS].[Directory_Reason_Discrepancy] ([id])
GO

ALTER TABLE [IDS].[OutgoingCars] CHECK CONSTRAINT [FK_OutgoingCars_Directory_Reason_Discrepancy]
GO

ALTER TABLE [IDS].[OutgoingCars]  WITH CHECK ADD  CONSTRAINT [FK_OutgoingCars_Directory_Reason_Discrepancy1] FOREIGN KEY([id_reason_discrepancy_amkr])
REFERENCES [IDS].[Directory_Reason_Discrepancy] ([id])
GO

ALTER TABLE [IDS].[OutgoingCars] CHECK CONSTRAINT [FK_OutgoingCars_Directory_Reason_Discrepancy1]
GO
...
ALTER TABLE [IDS].[OutgoingCars]  WITH CHECK ADD  CONSTRAINT [FK_OutgoingCars_OutgoingDetentionReturn] FOREIGN KEY([id_outgoing_detention])
...
ALTER TABLE [IDS].[OutgoingCars]  WITH CHECK ADD  CONSTRAINT [FK_OutgoingCars_OutgoingDetentionReturn1] FOREIGN KEY([id_outgoing_return_start])
REFERENCES [IDS].[OutgoingDetentionReturn] ([id])
GO
...
ALTER TABLE [IDS].[OutgoingCars]  WITH CHECK ADD  CONSTRAINT [FK_OutgoingCars_OutgoingDetentionReturn2] FOREIGN KEY([id_outgoing_return_stop])
REFERENCES [IDS].[OutgoingDetentionReturn] ([id])
GO
