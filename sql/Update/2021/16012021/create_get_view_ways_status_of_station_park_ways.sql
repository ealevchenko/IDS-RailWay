...
/****** Object:  UserDefinedFunction [IDS].[get_view_park_ways_status_of_station]    Script Date: 16.01.2021 13:49:25 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_ways_status_of_station_park_ways]
 (
    @id_station int,
    @id_park int
 )
