...
/****** Object:  UserDefinedFunction [IDS].[get_view_sostav_of_period_operation_send]    Script Date: 13.10.2021 15:52:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_sostav_of_period_operation_send]
 (
		@start datetime, 
		@stop datetime
 )
...
BEGIN
	...
	from [IDS].[get_view_wagons_of_period_operation_send](@start, @stop) as fwag
