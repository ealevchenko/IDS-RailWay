...
/****** Object:  UserDefinedFunction [IDS].[get_view_wagons_of_way]    Script Date: 24.03.2021 17:55:02 ******/
SET ANSI_NULLS ON
GO
 ...
 (
	@id_way int
		...
		@view_wagons TABLE  (
			...
			[current_id_operation_wagon] [int] NOT NULL,
		...
		FROM IDS.WagonInternalMovement as wim INNER JOIN
			...
			IDS.OutgoingSostav as out_sostav ON out_car.id_outgoing = out_sostav.id														--> Состав отправка
