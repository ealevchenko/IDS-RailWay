...
/****** Object:  UserDefinedFunction [IDS].[get_view_outgoing_cars_of_id_sostav]    Script Date: 28.12.2021 16:08:13 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_outgoing_cars_of_id_sostav]
 (
	@id_sostav int
 )
	RETURNS 
	...
	order by out_car.position	RETURN
 END
