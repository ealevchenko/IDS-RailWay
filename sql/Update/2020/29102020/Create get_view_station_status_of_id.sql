...
/****** Object:  UserDefinedFunction [IDS].[get_view_station_status_of_id]    Script Date: 02.11.2020 21:28:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_station_status_of_id]
 (
   @id_station int
 )
	RETURNS 
