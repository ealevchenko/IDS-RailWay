...
/****** Object:  UserDefinedFunction [IDS].[get_view_ways_status_of_station_park]    Script Date: 07.11.2020 22:00:54 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_ways_status_of_station_park]
 (
   @id_station int,
   @id_park int
 )
	...
	where w.[id_station]=@id_station and w.[id_park] = @id_park  ORDER BY [position_way]
  RETURN
 END
