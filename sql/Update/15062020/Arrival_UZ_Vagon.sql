...
/****** Object:  Table [IDS].[Arrival_UZ_Vagon]    Script Date: 15.06.2020 12:13:20 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_Cars] FOREIGN KEY([id_car])
REFERENCES [IDS].[Directory_Cars] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_Cars]
GO
