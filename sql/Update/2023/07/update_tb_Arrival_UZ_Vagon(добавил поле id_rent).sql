...
/****** Object:  Table [IDS].[Arrival_UZ_Vagon]    Script Date: 11.07.2023 13:22:21 ******/
SET ANSI_NULLS ON
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_Countrys] FOREIGN KEY([id_countrys])
REFERENCES [IDS].[Directory_Countrys] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_Countrys]
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_GenusWagons] FOREIGN KEY([id_genus])
REFERENCES [IDS].[Directory_GenusWagons] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_GenusWagons]
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_OwnersWagons] FOREIGN KEY([id_owner])
REFERENCES [IDS].[Directory_OwnersWagons] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_OwnersWagons]
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_TypeOwnerShip] FOREIGN KEY([id_type_ownership])
REFERENCES [IDS].[Directory_TypeOwnerShip] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_TypeOwnerShip]
GO
...
ALTER TABLE [IDS].[Arrival_UZ_Vagon]  WITH CHECK ADD  CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_WagonsRent] FOREIGN KEY([id_wagons_rent_arrival])
REFERENCES [IDS].[Directory_WagonsRent] ([id])
GO

ALTER TABLE [IDS].[Arrival_UZ_Vagon] CHECK CONSTRAINT [FK_Arrival_UZ_Vagon_Directory_WagonsRent]
GO
