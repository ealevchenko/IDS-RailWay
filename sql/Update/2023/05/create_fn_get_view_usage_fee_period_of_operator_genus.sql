...
/****** Object:  UserDefinedFunction [IDS].[get_view_usage_fee_period_of_period]    Script Date: 16.05.2023 8:56:38 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_usage_fee_period_of_operator_genus]
 (
	@id_operator datetime, 
	@id_genus datetime
 )
	RETURNS 
	@view_ufp TABLE  (
	...
	SELECT	ufp.[id] as id_usage_fee_period
	  ...
	  where ufp.[id_operator] = @id_operator and ufp.[id_genus] >= @id_genus
	RETURN
 END
