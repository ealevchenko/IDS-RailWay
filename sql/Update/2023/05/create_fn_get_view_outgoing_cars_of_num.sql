...
/****** Object:  UserDefinedFunction [IDS].[get_view_outgoing_cars_of_id_car]    Script Date: 08.05.2023 12:05:15 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_outgoing_cars_of_num]
 (
	@num int
 )
	RETURNS 
	@view_wagons TABLE  (
		...
		[num] [int] NULL,
		[outgoing_car_position] [int] NULL,
		-- добавил 13-02-2022		
		[id_wir] [bigint] NULL,
		-- убрал 13-02-2022	
		---- добавил 1-02-2022
		--[wagon_id_countrys] [int] NULL,
		--[wagon_wagon_adm] [int] NULL,
		...
		---- добавил 31-01-2022
		--[last_operation_id_operation] [int] NULL,
		--[last_operation_id_condition] [int] NULL,
		--[last_operation_condition_name_ru] [nvarchar](100) NULL,
		--[last_operationt_condition_name_en] [nvarchar](100) NULL,
		--[last_operation_condition_abbr_ru] [nvarchar](20) NULL,
		--[last_operation_condition_abbr_en] [nvarchar](20) NULL,
		--[last_operation_condition_red] [bit] NULL,
		--
		...
		[outgoing_sostav_id] [bigint] NOT NULL,
		[outgoing_sostav_num_doc] [int] NOT NULL,
		[outgoing_sostav_id_station_from] [int] NOT NULL,
		...
		[outgoing_sostav_id_way_from] [int] NOT NULL,
		...
		[outgoing_sostav_date_readiness_amkr] [datetime] NOT NULL,
		...
		[outgoing_sostav_status] [int] NOT NULL,
		[outgoing_sostav_route_sign] [bit] NULL,
		[outgoing_sostav_note] [nvarchar](200) NULL,
		[outgoing_sostav_create] [datetime] NOT NULL,
		[outgoing_sostav_create_user] [nvarchar](50) NOT NULL,
