...
/****** Object:  UserDefinedFunction [IDS].[get_view_wagons_of_all_outer_ways]    Script Date: 13.01.2022 17:21:53 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_wagons_of_outer_ways_station_on]
 (
	@id_station_on int
 )
		RETURNS 
...
BEGIN
	...
	WHERE wim_from.[num_sostav] is not null and outer_ways.[id_station_on] = @id_station_on
