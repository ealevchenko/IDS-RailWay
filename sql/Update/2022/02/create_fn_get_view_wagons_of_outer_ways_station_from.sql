...
/****** Object:  UserDefinedFunction [IDS].[get_view_wagons_of_outer_ways_station_on]    Script Date: 10.02.2022 15:21:58 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_wagons_of_outer_ways_station_from]
 (
	@id_station_from int
 )
		RETURNS 
...
BEGIN
	...
	WHERE wim_from.[num_sostav] is not null and wim_from.[id_station] = @id_station_from
