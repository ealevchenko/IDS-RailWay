...
/****** Object:  UserDefinedFunction [IDS].[get_view_incoming_cars_of_period]    Script Date: 04.08.2022 16:35:21 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [IDS].[get_view_incoming_cars_of_period]
 (
	@start datetime, 
	@stop datetime
 )
	...
	[id_wir] [bigint] NULL,
	-- Добавил 21-06-2022
	[arrival_car_id_outgoing_car] [bigint] NULL,
	[arrival_car_id_outgoing_uz_vagon] [bigint] NULL,
	-- Добавил 10-05-2022
	[arrival_car_wim_cur_id] [bigint] NULL,
	[arrival_car_wim_cur_id_wagon_internal_routes] [bigint] NULL,
	[arrival_car_wim_cur_id_station] [int] NULL,
	[arrival_car_wim_cur_station_name_ru] [nvarchar](50) NULL,
	[arrival_car_wim_cur_station_name_en] [nvarchar](50) NULL,
	[arrival_car_wim_cur_station_abbr_ru] [nvarchar](50) NULL,
	[arrival_car_wim_cur_station_abbr_en] [nvarchar](50) NULL,
	[arrival_car_wim_cur_id_way] [int] NULL,
	[arrival_car_wim_cur_way_on_id_park] [int] NULL,
	[arrival_car_wim_cur_way_num_ru] [nvarchar](20) NULL,
	[arrival_car_wim_cur_way_num_en] [nvarchar](20) NULL,
	[arrival_car_wim_cur_way_name_ru] [nvarchar](100) NULL,
	[arrival_car_wim_cur_way_name_en] [nvarchar](100) NULL,
	[arrival_car_wim_cur_way_abbr_ru] [nvarchar](50) NULL,
	[arrival_car_wim_cur_way_abbr_en] [nvarchar](50) NULL,
	[arrival_car_wim_cur_way_start] [datetime] NULL,
	[arrival_car_wim_cur_way_end] [datetime] NULL,
	[arrival_car_wim_cur_id_outer_way] [int] NULL,
	[arrival_car_wim_cur_name_outer_way_ru] [nvarchar](150) NULL,
	[arrival_car_wim_cur_name_outer_way_en] [nvarchar](150) NULL,
	[arrival_car_wim_cur_outer_way_start] [datetime] NULL,
	[arrival_car_wim_cur_outer_way_end] [datetime] NULL,
	[arrival_car_wim_cur_position] [int] NULL,
	[arrival_car_wim_cur_note] [nvarchar](250) NULL,
	[arrival_car_wim_cur_parent_id] [bigint] NULL,
	[arrival_car_wim_cur_id_wio] [bigint] NULL,
	[arrival_car_wim_cur_num_sostav] [nvarchar](50) NULL,
	--
	...
	[arrival_sostav_id] [bigint] NOT NULL,
	[arrival_sostav_id_arrived] [bigint] NULL,
	[arrival_sostav_id_sostav] [bigint] NULL,
	[arrival_sostav_train] [int] NOT NULL,
	[arrival_sostav_composition_index] [nvarchar](50) NOT NULL,
	...
	[arrival_sostav_status] [int] NOT NULL,
	[arrival_sostav_note] [nvarchar](200) NULL,
	[arrival_sostav_create] [datetime] NOT NULL,
	[arrival_sostav_create_user] [nvarchar](50) NOT NULL,
