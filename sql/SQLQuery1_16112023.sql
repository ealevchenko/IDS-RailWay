...
SELECT [id]
 ...
 -- SET [id_document] = null
	--WHERE id in (SELECT [id_outgoing_uz_vagon] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231953 and num in (66352576,56199953,55102172,55733018))

 --UPDATE [IDS].[OutgoingCars]
 --  SET [num_doc] = null
 --WHERE id in (SELECT [id] FROM [KRR-PA-CNT-Railway].[IDS].[OutgoingCars] where [id_outgoing]=231953 and num in (66352576,56199953,55102172,55733018))
