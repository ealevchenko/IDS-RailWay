...
declare @start datetime = '2026-05-01 20:01';
declare @stop datetime = '2026-05-02 20:00';
declare @id_station int = 2;
...
select * from [IDS].[get_view_wagons_filing_of_period_id_station](@start,@stop,@id_station);
	...
	SELECT
		--> Внутренее перемещение
		 ...
		 --,wio_filing.[operation_start]
		 --,wio_filing.[operation_end]
		 --,dir_operator.id
		 --,filing_dir_operator.id
