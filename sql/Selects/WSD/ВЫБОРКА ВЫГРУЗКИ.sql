...
SELECT 
	  ...
	  ,wio.[operation_end] as 'Дата окончания выгрузки'
	  ,dir_station_amkr.station_abbr_ru as 'Станция выгрузки'
  ...
  where wio.[id_operation] in (13,14) and wio.[operation_start] >= '2025-07-01 00:00:00.000' and wio.[operation_end]<= '2025-10-20 00:00:00.000'
