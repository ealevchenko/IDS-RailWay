...
declare @stop datetime = Convert(datetime, '2023-01-09 23:59:59', 120)
	...
	select 
		...
		--> ÑÏĞÀÂÎ×ÍÈÊ ÃĞÓÏÏÀ ÃĞÓÇÀ [IDS].[Directory_CargoOutGroup]	
		,out_dir_cargo.[id_out_group] as outgoing_uz_vagon_id_out_group								-- id ãğóïïà ãğóçà [IDS].[Directory_CargoOutGroup] ïî îòïğàâêå [IDS].[Outgoing_UZ_Vagon]
		,out_dir_group_out_cargo.cargo_group_name_ru as outgoing_uz_vagon_cargo_out_group_name_ru	-- Ãğóïïà ãğóçîâ [IDS].[Directory_CargoOutGroup] ïî îòïğàâêå [IDS].[Outgoing_UZ_Vagon]
		,out_dir_group_out_cargo.cargo_group_name_en as outgoing_uz_vagon_cargo_out_group_name_en	-- Ãğóïïà ãğóçîâ [IDS].[Directory_CargoOutGroup] ïî îòïğàâêå [IDS].[Outgoing_UZ_Vagon]
		--> ÑÏĞÀÂÎ×ÍÈÊ ÃĞÓÇÀ ÅÒÑÍÃ [IDS].[Directory_CargoETSNG]
		...
		--> Ñïğàâî÷íèê Ãğóïïû ïî îòïğàâêå Ãğóçîâ ïî îòïğàâêå
