...
declare @stop datetime = convert(datetime,'2023-12-31',120);
	...
	select 
		...
		,arr_group_dir_operator.[id] as arrival_uz_vagon_arrival_wagons_rent_group_id_operator			-- id строки оператор [IDS].[Directory_OperatorsWagons] по отправке [IDS].[Outgoing_UZ_Vagon]
		,arr_group_dir_operator.[operators_ru] as arrival_uz_vagon_arrival_wagons_rent_group_operators_ru	-- Оператор [IDS].[Directory_OperatorsWagons] по отправке [IDS].[Outgoing_UZ_Vagon]
		,arr_group_dir_operator.[operators_en] as arrival_uz_vagon_arrival_wagons_rent_group_operators_en	-- Оператор [IDS].[Directory_OperatorsWagons] по отправке [IDS].[Outgoing_UZ_Vagon]
		,arr_group_dir_operator.[abbr_ru] as arrival_uz_vagon_arrival_wagons_rent_operator_group_abbr_ru	-- Оператор [IDS].[Directory_OperatorsWagons] по отправке [IDS].[Outgoing_UZ_Vagon]
		,arr_group_dir_operator.[abbr_en] as arrival_uz_vagon_arrival_wagons_rent_operator_group_abbr_en	-- Оператор [IDS].[Directory_OperatorsWagons] по отправке [IDS].[Outgoing_UZ_Vagon]
