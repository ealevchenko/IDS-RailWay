use [KRR-PA-CNT-Railway-Archive]
	...
	select 
		...
		-->======================================================================================================
		--> Входящая поставка [IDS].[SAPIncomingSupply] исправил 27.04.2022
...
--select * from [IDS].[get_view_incoming_cars_of_id_sostav](346778) order by arrival_car_position
--select * from [IDS].[get_view_incoming_cars_of_id_sostav](346777) order by arrival_car_position