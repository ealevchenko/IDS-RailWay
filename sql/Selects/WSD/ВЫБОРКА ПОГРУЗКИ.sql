...
SELECT 
	  ...
	  ,wio.[operation_end] as 'Дата окончания погрузки'
	  ,dir_station_amkr.station_abbr_ru as 'Станция погрузки'
	  ,dir_division_amkr.division_abbr_ru as 'Цех-погрузки'
  ...
  where wio.[id_operation] in (15,16) and wio.[operation_start] >= '2025-07-01 00:00:00.000' and wio.[operation_end]<= '2025-10-20 00:00:00.000'
