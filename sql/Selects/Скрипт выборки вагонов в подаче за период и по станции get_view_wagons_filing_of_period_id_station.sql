use [KRR-PA-CNT-Railway-Test]
	...
	declare @start datetime = '2026-07-02 00:00:00';
	declare @stop datetime = '2026-07-02 23:59:59';
	declare @id_station int =1;
	...
	and wim_filing.id_station = @id_station and wir.[num] in (56279805, 56760952) and wf.id = 229286
