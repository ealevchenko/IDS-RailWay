...
SELECT TOP (1000) [id]
  ...
  where [date_adoption] >= @start and [date_adoption] <= @stop
  ...
  where [id_arrival] in (select [id] FROM [KRR-PA-CNT-Railway].[IDS].[ArrivalSostav] where [date_adoption] >= @start and [date_adoption] <= @stop)
