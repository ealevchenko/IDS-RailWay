...
namespace IDS
{
    public enum errors_base : int
    {
        ...
        error_date = -102,                          // Ошибка, дата непрошла валидацию
        ...
        not_arrival_cars_db = -505,                // В базе данных нет записи по вагонам для отпправки
        arrival_cars_arrival = -506,               // Запрет операции вагон уже отправлен
        // документы по прибытию
        not_arrival_uz_vagon = -551,               // Ошибка, нет записи или сылки на документ прибывшего вагона  
        ...
        // Directory_Ways -1100..
        not_dir_way_of_db = -1101,                     // В базе данных нет записи указаной строки пути
        way_not_crossing_uz = -1102,                // Путь неимеет выход на УЗ
        // Directory_Wagons -1200..
        not_dir_wagon_of_db = -1201,                // В базе данных нет записи указаной строки вагона
