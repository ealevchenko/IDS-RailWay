...
namespace Test.TestModule
{
    public class Test_IDS
    {
        ...
        {
            IDS_WIR ids = new IDS_WIR(service.Test);
            List<int> list = new List<int>() { 466453, 545034, 466510, 731547, 731548, 731549, 731550, 731551, 731552, 731553, 731563, 588330, 590824, 590860, 590872, 590874, 590875, 590877, 591131, 591244, 603843, 606355, 606362, 606365, 606621, 617235, 617238, 617240, 617242, 617682, 659122, 730985, 731398, 731399, 731403, 731404, 731407, 731408, 731411, 731412, 731413, 731414, 731545, 731546 };
        ...
        public void IDS_WIR_CalcUsageFeeOfOutgoingSostav()
        {
            ...
            ResultUpdateIDWagon result = ids.CalcUsageFeeOfOutgoingSostav(221501, @"EUROPE\ealevchenko");
        }
