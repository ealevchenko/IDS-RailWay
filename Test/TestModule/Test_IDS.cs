...
namespace Test.TestModule
{
    public class Test_IDS
    {
        ...
        {
            IDS_WIR ids = new IDS_WIR(service.Test);
            OperationResultWagon res = ids.OperationUpdateEPDSendingSostav(64117, "TEST");
        }
        ...
        {
            IDS_WIR ids = new IDS_WIR(service.Test);
            List<int> list = new List<int>() { 246422, 247297, 246961, 247298, 245203, 247331, 247300, 247469, 247453, 245343, 245347, 245581, 247295, 247329, 245726, 247455, 247292, 247289, 247326, 247301, 247330, 247470, 247462, 247452, 246187, 247468, 247291, 247465, 247293, 247463, 247464, 247290, 247466, 247294, 247227, 247467, 247325, 247324, 247327, 247328, 241815 };
        ...
        {
            IDS_WIR ids = new IDS_WIR(service.Test);
            List<int> list = new List<int>() { 243354, 243393, 243861, 243879, 243886, 243897, 243890, 243893, 243344, 243397, 243731, 243882, 243884, 243395, 243888, 243895, 243891, 243892, 243394, 243396, 243730, 243860, 243862, 243887, 243889, 243894, 243896, 243885, 243898 };
