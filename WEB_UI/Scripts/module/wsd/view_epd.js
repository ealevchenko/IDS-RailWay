...
(function (window) {
    ...
    $.Text_View =
    {
        ...
        {
            'vepd_field_epd_id_doc': 'doc-id.',
            'vepd_field_epd_revision': 'rev no',
            'vepd_field_epd_num_uz': 'vepd_field_epd_num_uz',
            'vepd_field_epd_status': 'Status',
            'vepd_field_epd_sender_code': 'Sender',
            'vepd_field_epd_recipient_code': 'Consignee',
            'vepd_field_epd_dt': 'Updated',
            'vepd_field_epd_xml_final': 'XML',

            'vepd_field_doc_id': 'Document ID at the base of JSC "Ukrzaliznytsia"',
            'vepd_field_doc_description': 'Document Description',
            'vepd_field_doc_doc_date': 'Document date',
            'vepd_field_doc_doc_type': 'Support Document Type Code',
            'vepd_field_doc_doc_type_name': 'Support Document Type Name',
            'vepd_field_doc_kod_zd_use': 'Document field code',
            'vepd_field_doc_kol': 'Number of instances',

            'vepd_field_act_carrier_kod': 'Vepd_field_act_carrier_kod',
            'vepd_field_act_carrier_name': 'Vepd_field_act_carrier_name',
            'vepd_field_act_date_akt': 'Date of act creation',
            'vepd_field_act_date_dved': 'Date of laying the overhead roadway',
            'vepd_field_act_esr_akt': 'ESR station fold act',
            'vepd_field_act_stn_name_akt': 'Name of the station put in the act',
            'vepd_field_act_nom_akt': 'Act number',
            'vepd_field_act_nom_dved': 'Vepdable road number',
            'vepd_field_act_oper_date': 'Date of entry of data on the act of the transport document',
            'vepd_field_act_prichina_akt': 'Reason',
            'vepd_field_act_responsible_person': 'The name of the individual responsible for entering data on the act of the transportation document',
            'vepd_field_act_ser_dved': 'Vepd_field_act_ser_dved',
            'vepd_field_act_type': 'Act type',
            'vepd_field_act_vagon_nom': 'Vagon number ',
            'vepd_field_act_zd_kod': 'Vepd_field_act_zd_kod',

            'vepd_field_cont_nom_cont': 'Container number',
            'vepd_field_cont_kod_tiporazmer': 'Container Type',
            'vepd_field_cont_gruzp': 'Gross weight per stencil (t)',
            'vepd_field_cont_ves_tary_arc': 'Mat tare container (kg)',
            'vepd_field_cont_vesg': 'vepd net weight (kg)',
            'vepd_field_cont_brutto': 'Vaga vantage gross',
            'vepd_field_cont_kod': 'Payment Code',
            'vepd_field_cont_summa': 'Amount of payment (cop)',
            'vepd_field_cont_nom_zpu': 'Vepd_field_cont_nom_zpu',
            'vepd_field_cont_kol_pac': 'Number of packing area',
            'vepd_field_cont_kod_etsng': 'Vantage code by ЄTSNV',

            'vepd_mess_init_module': 'Module initialization(view_epd)...',
            'vepd_title_yes': 'Yes',
            'vepd_title_all': 'All',
            'vepd_title_button_export': 'Export',
            'vepd_title_button_buffer': 'Buffer',
            'vepd_title_button_excel': 'Excel',
            'vepd_title_excel_sheet_name': 'Vepd Information',
            'vepd_title_button_field': 'Fields',
            'vepd_title_button_field_select': 'Select',
            'vepd_title_button_field_view_all': 'Show All',
            'vepd_title_button_field_clear': 'Reset',

            'vepd_field_epd_status_unknown': 'Unknown status',
            'vepd_field_epd_status_draft': 'Draft',
            'vepd_field_epd_status_sending': 'Document is being sent to the cashier',
            'vepd_field_epd_status_registered': 'Document of transfers to the commodity cashier',
            'vepd_field_epd_status_reclaiming': 'Document reclaimed by cashier',
            'vepd_field_epd_status_accepted': 'Vantage accepted before moving',
            'vepd_field_epd_status_delivered': 'vepd vantage',
            'vepd_field_epd_status_recieved': 'Vantage received by owner',
            'vepd_field_epd_status_uncredited': 'Vepd_field_epd_status_uncredited',
            'vepd_field_epd_status_recieved_draft': 'Vantage received and edited',
            'vepd_field_epd_status_recieved_sending': 'Vantage received by the receiver and sent to the cashier',
            'vepd_field_epd_status_recieved_reclaiming': 'Reclaimed Reclaimed and Reclaimed as a Cashier',
            'vepd_field_epd_status_canceled': 'Vepd_field_epd_status_canceled',
            'vepd_field_epd_status_locked': 'Lock Document',

            'vepd_mess_load_epd_docs': 'Loading information from EPD (Certificates and other documents)...',
            'vepd_mess_load_epd_acts': 'Loading information from EPD (Vehicle Acts)...',
            'vepd_mess_load_epd_conts': 'Loading information from an EPD (Container)...',
            'vepd_mess_update_epd': 'Updating EPD info...',
        }
    };
