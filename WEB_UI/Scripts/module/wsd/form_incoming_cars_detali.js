...
(function (window) {
    ...
    $.Text_View =
    {
        'default':  //default language: ru
        {
            ...
            'ficcd_mess_run_operation_change_mode_return': 'Возврат вагона...',
            ...
            'fogcd_mess_warning_no_data_return_wagon': 'По указанному ID {0} вагона нет данных по отправке в БД ИДС.',
            ...
            'ficcd_message_mode_return': 'Внимание! Вагон возвратный. Документ №{0} был взят из последней отправки!',
            ...
            'ficcd_message_mode_7': 'Внимание! По указанному вагону будет указан ЭПД предыдущего отправления на УЗ, карточка переведена в ручной режим ввода, введите в ручную недостающую информацию.',
        ...
        {
            'ficcd_label_arrival_car': 'Accept wagon',
            'ficcd_label_return_car': 'Return car',
            'ficcd_title_search_car': 'Find ETD by car number',
            'ficcd_title_manual_car': 'Enter data manually',
            'ficcd_title_search_main_doc': 'Find the main document in CF',
            'ficcd_title_change_main_doc': 'Edit Main Invoice #',
            'ficcd_title_search_doc': 'Search for a resending document on the UZ',
            'ficcd_title_change_doc': 'Edit Shipping Waybill No.',

            'ficcd_label_num': 'Car#:',
            'ficcd_title_num': 'Car number',
            'ficcd_label_position_arrival': 'Train number:',
            'ficcd_title_position_arrival': 'Automatic entry\adjustment (wagon number in train)',
            'ficcd_label_date_adoption_act': 'Time and date of acceptance by act:',
            'ficcd_title_date_adoption_act': 'Manual entry (if the car is accepted by act)',

            'fogcd_label_not_epd': 'No EPD',
            'fogcd_label_return': 'Return',
            'ficcd_label_document_nom_doc': 'Shipping Waybill No:',
            'ficcd_title_document_nom_doc': 'Sending waybill number',
            'ficcd_label_document_nom_main_doc': 'Main invoice number:',
            'ficcd_title_document_nom_main_doc': 'Main invoice number',
            'ficcd_title_fieldset_routes_clients': 'ROUTES AND CLIENTS',
            'ficcd_title_fieldset_wagon_card': 'WAGON CARD',
            'ficcd_title_fieldset_payer': 'PAID',
            'ficcd_title_fieldset_cargo': 'CARGO',
            'ficcd_title_fieldset_sap': 'SAP (INCOMING DELIVERY)',
            'ficcd_title_sap_material': 'Material',
            'ficcd_title_sap_warehouse': 'Readdress',
            'ficcd_title_sap_warehouse_new': 'Redirect (Redirect 10km)',

            'ficcd_title_fieldset_departure_station': 'Departure Station',
            'ficcd_label_code_stn_from': 'Code:',
            'ficcd_title_code_stn_from': 'EPD [OTPR/ROUTE/stn_from] -> Origin station code',
            'ficcd_label_station_from_name': 'Name:',
            'ficcd_title_station_from_name': 'EPD [OTPR/ROUTE/name_from] -> Directory "External Stations" -> Directory "Roads" -> Name of the dispatch station',
            'ficcd_label_from_inlandrailway_name': 'Road:',
            'ficcd_title_from_inlandrailway_name': 'Automatically taken from "Roads" directory -> Road name',

            'ficcd_title_fieldset_incoming_station': 'Incoming Station',
            'ficcd_label_code_stn_on': 'Code:',
            'ficcd_title_code_stn_on': 'ETD [OTPR/ROUTE/stn_on] -> Arrival station code',
            'ficcd_label_station_on_name': 'Name:',
            'ficcd_title_station_on_name': 'EPD [OTPR/ROUTE/name_on] -> "Outside Stations" Directory -> "Roads" Directory -> Arrival Station Name',
            'ficcd_label_on_inlandrailway_name': 'Road:',
            'ficcd_title_on_inlandrailway_name': 'Automatically taken from "Roads" directory -> Road name',

            'ficcd_title_fieldset_border_crossing': 'Border Point',
            'ficcd_label_stn_border': 'Code:',
            'ficcd_title_stn_border': 'EPD [OTPR/ROUTE/JOINT/stn] - Border crossing code',
            'ficcd_label_stn_border_name': 'Name:',
            'ficcd_title_stn_border_name': 'EPD [OTPR/ROUTE/JOINT/stn_name] -> Directory "Border crossings" -> Border crossing station name',
            'ficcd_label_border_cross_time': 'Crossover date and time:',
            'ficcd_title_border_cross_time': 'EPD [OTPR/ROUTE/JOINT/cross_time] - Transition time',

            'ficcd_label_shipper_code': 'Code:',
            'ficcd_title_shipper_code': 'EPD [OTPR/CLIENT[0]/kod] -> Shipper code',
            'ficcd_label_shipper_name': 'Shipper:',
            'ficcd_title_shipper_name': 'EPD [OTPR/CLIENT[0]/name] -> "Shipper" directory -> Shipper name',

            'ficcd_label_consignee_code': 'Code:',
            'ficcd_title_consignee_code': 'EPD [OTPR/CLIENT[1]/kod] -> Consignee code',
            'ficcd_label_consignee_name': 'Consignee:',
            'ficcd_title_consignee_name': 'EPD [OTPR/CLIENT[1]/name] -> "Consignees" directory -> Consignee name',

            'ficcd_label_station_amkr_name': 'Send to AMKR Station:',
            'ficcd_title_station_amkr_name': 'Manual selection -> Directory of "AMKR units"',
            'ficcd_title_station_amkr_for_loading': 'Loading',
            'ficcd_label_division_code': 'Code:',
            'ficcd_title_division_code': 'Manual selection -> "AMCR divisions" directory',
            'ficcd_label_division_name': 'Shop\warehouse:',
            'ficcd_title_division_name': 'Manual selection -> "AMCR divisions" directory',

            'ficcd_title_add_station_from': 'Add a new external station to the "External Stations" directory of the CID, information is taken automatically from the EPD',
            'ficcd_title_add_station_on': 'Add a new external station to the "External Stations" CID directory, information is taken automatically from the EPD',
            'ficcd_title_add_stn_border': 'Add a new border crossing to the IDS "Border crossings" directory, information is taken automatically from the EPD',
            'ficcd_title_add_shipper': 'Add a new shipper to the IDS "Shippers" directory, information is taken automatically from the EPD',
            'ficcd_title_add_name_plat': 'Add a new payer to the "Payers on arrival" directory, information is taken automatically from the EPD',
            'ficcd_title_add_cargo_etsng': 'Add a new cargo to the "ET CIS Cargo" directory, information is taken automatically from the EPD',
            'ficcd_title_add_cargo_gng': 'Add a new cargo to the "GNG Cargo" directory, information is taken automatically from the EPD',
            'ficcd_title_add_inbound_delivery': 'Get SAP Inbound Delivery Line',

            'fogcd_label_route_flag': 'Route flag',
            'fogcd_title_wagon_card_save': 'Add a new wagon card record to the "Wagon Card" directory, information is taken automatically from the EPD and the UZ database',
            'fogcd_title_wagon_card_edit': 'Edit the wagon card entry in the "Wagon Card" directory, information is taken automatically from the EPD and UZ database',

            'ficcd_label_kod_adm': 'Admin Code:',
            'ficcd_title_kod_adm': 'ETD [OTPR/VAGON/kod_adm]',
            'ficcd_label_name_adm': 'Country:',
            'ficcd_title_name_adm': 'ETD [OTPR/VAGON/kod_adm] -> Directory of "Countries" -> Administration Name',
            'ficcd_label_rod_vag': 'Car type:',
            'ficcd_title_rod_vag': 'EPD [OTPR/VAGON/rod_vag] -> Directory "Type of car" -> Directory "Car card" -> Name of "Type of car"',

            'ficcd_label_usl_tip': 'Tan Type:',
            'ficcd_title_usl_tip': 'ETD [OTPR/VAGON/usl_tip] -> Directory "Wagon card" -> Cipher "Tanker type"',
            'ficcd_label_condition_arrival': 'Label on arrival:',
            'ficcd_title_condition_arrival': 'Manual selection -> Eligibility on arrival lookup',
            'ficcd_label_type_wagon': 'Wagon type:',
            'ficcd_title_type_wagon': 'Manual selection -> Wagon type lookup',

            'ficcd_label_kol_os': 'Number of axles:',
            'ficcd_title_kol_os': 'EPD [OTPR/VAGON/kol_os] -> Reference book "Car card" -> Number of axles',
            'ficcd_label_gruzp': 'Cargo. (EPD),t:',
            'ficcd_title_gruzp': 'EPD [OTPR/VAGON/gruzp] -> EPD Payload',
            'ficcd_label_gruzp_uz': 'Cargo. (UZ),t:',
            'ficcd_title_gruzp_uz': 'UZ DB [https://uz.gov.ua/car_info/index.php] -> Payload according to UZ DB',
            'ficcd_label_tara_uz': 'Tara(UZ),t:',
            'ficcd_title_tara_uz': 'UZ DB [https://uz.gov.ua/car_info/index.php] -> Tare according to UZ DB',

            'ficcd_label_ves_tary_arc': 'Tare weight (EPD), t:',
            'ficcd_title_ves_tary_arc': 'ETD [OTPR/VAGON/ves_tary_arc] -> ETD tare weight',
            'ficcd_label_u_tara': 'Tare weight (ut.EPD), t:',
            'ficcd_title_u_tara': 'EPD [OTPR/VAGON/u_tara] -> EPD tare weight',
            'ficcd_label_date_rem_vag': 'Repair date(car):',
            'ficcd_title_date_rem_vag': 'Manual entry (information on the car) -> "Car card" lookup -> Repair date on the car',
            'ficcd_label_date_rem_uz': 'Repair Date (UZ DB):',
            'ficcd_title_date_rem_uz': 'UZ DB [https://uz.gov.ua/car_info/index.php] -> Directory "Car Card" -> Repair date according to UZ DB',

            'ficcd_label_name_owner': 'Owner:',
            'ficcd_title_name_owner': 'UZ database [https://uz.gov.ua/car_info/index.php] -> "Wagon owners" directory -> "Wagon card" directory -> Wagon owner',
            'ficcd_label_rent_start': 'Rent start:',
            'ficcd_title_rent_start': 'Manual entry (when changing ownership) -> Wagon card lookup -> Rental start date',
            'ficcd_label_type_ownership': 'Ownership Label:',
            'ficcd_title_type_ownership': 'Automatically taken from own wagon cards -> Ownership attribute',

            'ficcd_label_name_operator': 'Operator (FICCD):',
            'ficcd_title_name_operator': 'UZ database [https://uz.gov.ua/car_info/index.php] -> Directory "Operators" -> Directory "Car card" -> Car operator',
            'ficcd_label_limiting_loading': 'Loading limit:',
            'ficcd_title_limiting_loading': 'Automatically taken from the "Wagon Card" -> Loading Restriction',

            'fogcd_label_wagon_note_uz': 'UZ limits (UZ DB):',
            'fogcd_title_wagon_note_uz': 'Uz DB [https://uz.gov.ua/car_info/index.php] -> Reference "Wagon card" -> Restrictions from UZ DB',
            'fogcd_label_wagon_note': 'Note:',
            'fogcd_title_wagon_note': 'Manual entry (notes)',

            'fogcd_title_docs': 'Accompanying documents, if documents are attached to the EPD, then the number of documents will be indicated',
            'fogcd_text_docs': 'Certificates and other documents for EPD',
            'fogcd_title_acts': 'Acts, if acts are nested in the ETD, then the number of acts will be indicated',
            'fogcd_text_acts': 'EPD Acts',
            'fogcd_title_acts_wagon': 'Acts per wagon, if acts are attached to the ETD for the selected wagon, then the number of acts will be indicated',
            'fogcd_text_acts_wagon': 'Wagon Acts',
            'fogcd_title_wagon_cont': 'Containers per wagon, if there are containers in the EPD for the selected wagon, then the number of containers will be indicated',
            'fogcd_text_wagon_cont': 'Container',

            'ficcd_label_kod_plat': 'Code:',
            'ficcd_title_kod_plat': 'EPD [OTPR/PL/kod_plat] -> Payer code from EPD',
            'ficcd_label_name_plat': 'Payer with EPD:',
            'ficcd_title_name_plat': 'EPD [OTPR/PL/name_plat] -> "Payers on Arrival" Directory -> Payer Name',
            'ficcd_label_distance_way': 'Tariff distance:',
            'ficcd_title_distance_way': 'EPD [OTPR/distance_way] -> Tariff distance',
            'ficcd_label_vagon_pay_v_summa': 'Dispatch Fare:',
            'ficcd_title_vagon_pay_v_summa': 'EPD [OTPR/VAGON/PAY_V/summa] if [OTPR/VAGON/PAY_V/kod=01 or OTPR/VAGON/PAY_V/kod=21]',

            'ficcd_label_kod_etsng': 'ETCNG Code:',
            'ficcd_title_kod_etsng': 'ETD [OTPR/VAGON/COLLECT_V/kod_etsng] -> ET CIS cargo code',
            'ficcd_label_name_etsng': 'ETCNG cargo name:',
            'ficcd_title_name_etsng': 'EPD [OTPR/VAGON/COLLECT_V/name_etsng] -> "CIS UT Cargo" Directory -> "IDS Cargo" Directory -> CIS UT Cargo Name',

            'ficcd_label_kod_gng': 'GNG Code:',
            'ficcd_title_kod_gng': 'EPD [OTPR/VAGON/COLLECT_V/kod_gng] -> GNG Cargo Code',
            'ficcd_label_name_gng': 'GNG Cargo Name:',
            'ficcd_title_name_gng': 'EPD [OTPR/VAGON/COLLECT_V/name_gng] -> GNG Cargo Directory -> GNG Cargo Name',

            'ficcd_label_group_cargo': 'Cargo group:',
            'ficcd_title_group_cargo': 'Automatically taken from "IDS Cargo" -> Cargo Group',
            'ficcd_label_certificate_data': 'Certificate Data:',
            'ficcd_title_certificate_data': 'Manual selection -> "Certificate data" lookup',
            'ficcd_label_commercial_condition': 'Commercial condition:',
            'ficcd_title_commercial_condition': 'Manual selection -> "Commercial condition of wagon/cargo" lookup',

            'fogcd_label_cargo_analysis': 'Cargo Analysis:',
            'fogcd_title_cargo_analysis': 'EPD [OTPR/TEXT/zayava] -> Information for cargo analysis',

            'ficcd_label_kol_pac': 'Number. places:',
            'ficcd_title_kol_pac': 'EPD [OTPR/VAGON/COLLECT_V/kol_pac] -> Number of seats',
            'ficcd_label_vesg': 'Cargo weight (incl.), t:',
            'ficcd_title_vesg': 'EPD [OTPR/VAGON/COLLECT_V/vesg] -> Cargo weight',
            'ficcd_label_vesg_reweighing': 'Weight(trans.), t:',
            'ficcd_title_vesg_reweighing': 'Automatically taken from the EDB system -> Cargo weight after reweighing',
            'ficcd_label_vesg_difference': 'Difference, t:',
            'ficcd_title_vesg_difference': 'Autocalculated after weight difference -> Weight difference',
            'ficcd_label_nom_zpu': 'ZPU #:',
            'ficcd_title_nom_zpu': 'EPD [OTPR/VAGON/ZPU_V/nom_zpu] -> ZPU Number',

            'ficcd_label_danger_class': 'Class:',
            'ficcd_title_danger_class': 'EPD [OTPR/VAGON/COLLECT_V/danger] -> Danger class',
            'ficcd_label_danger_name': 'Danger Class Description:',
            'ficcd_title_danger_name': 'EPD [OTPR/VAGON/COLLECT_V/danger] -> Directory "Hazard Class" -> Hazard Name',
            'ficcd_label_danger_kod': 'Danger Code:',
            'ficcd_title_danger_kod': 'EPD [OTPR/VAGON/COLLECT_V/danger_kod] -> Danger Code',

            'ficcd_label_num_input_sipply': 'Input Delivery No:',
            'ficcd_title_num_input_sipply': 'Get SAP line incoming deliveries',
            'ficcd_label_num_pos_sipply': 'Position No:',
            'ficcd_title_num_pos_sipply': '',
            'ficcd_label_delivery_dt_sipply': 'Created by:',
            'ficcd_title_delivery_dt_sipply': '',

            'ficcd_label_inbound_delivery_unloading_ban': 'Unloading ban:',
            'ficcd_title_inbound_delivery_unloading_ban': '',
            'ficcd_label_inbound_delivery_ship': 'Ship:',
            'ficcd_title_inbound_delivery_ship': '',

            'ficcd_label_inbound_delivery_material_code': 'Material Code:',
            'ficcd_title_inbound_delivery_material_code': '',
            'ficcd_label_inbound_delivery_material_name': 'Material Name:',
            'ficcd_title_inbound_delivery_material_name': '',

            'ficcd_label_inbound_delivery_warehouse_code': 'Warehouse code:',
            'ficcd_title_inbound_delivery_warehouse_code': '',
            'ficcd_label_inbound_delivery_warehouse_name': 'Warehouse:',
            'ficcd_title_inbound_delivery_warehouse_name': '',

            'ficcd_label_inbound_delivery_warehouse_code_new': 'Warehouse code:',
            'ficcd_title_inbound_delivery_warehouse_code_new': '',
            'ficcd_label_inbound_delivery_warehouse_name_new': 'Warehouse:',
            'ficcd_title_inbound_delivery_warehouse_name_new': '',

            'ficcd_form_add_db_ids': 'Add ids to directory?',
            'ficcd_form_message_add_ext_station_ids': 'Are you sure you want to add a new station {0}, with code {1}, to the "External Stations" directory of the IDS DB?',
            'ficcd_form_message_add_border_checkpoint_ids': 'Are you sure you want to add a new border crossing, station {0}, with code {1}?',
            'ficcd_form_message_add_shipper_ids': 'Are you sure you want to add a new shipper ID {0}, code {1}?',
            'ficcd_form_message_add_payer_sender_ids': 'Are you sure you want to add a new payer {0} with code {1} to the "Payers on Arrival" directory?',
            'ficcd_form_message_add_cargo_etsng_ids': 'Are you sure you want to add a new cargo {0}, with code {1}?',
            'ficcd_form_message_add_cargo_gng_ids': 'Are you sure you want to add a new cargo {0}, with code {1}?',

            'ficcd_form_return_arrival_car': 'Add CID to directory?',
            'ficcd_form_return_message_arrival_car': 'Are you sure you want to cancel the acceptance of car {0} to the AMCR?',
            'ficcd_form_continue': 'Cancel validation?',
            'ficcd_form_continue_not_check_numeration': 'Car {0} did not pass system numbering check! Do you want to continue the operation with validation disabled?',
            'ficcd_form_cancel_continue_not_check_numeration': 'Cancel check execution with system numbering disabled',

            'ficcd_mess_run_add_db_ids': 'Running "ADD {0} TO IDS DIRECTORY"...',
            'ficcd_mess_cancel_add_db_ids': 'Cancel the operation "ADD {0} TO IDS DIRECTORY"',
            'ficcd_mess_ok_add_db_ids': '"ADD {0} TO IDS DIRECTORY" operation completed',
            'ficcd_mess_error_add_db_ids': 'Error performing operation "ADD {0} TO DIRECTORY ids"',
            'ficcd_mess_ok_update_dir_wagon_db_ids': '"UPDATE {0} TO DIRS DIRECTORY" operation completed, card {1} {2}',
            'ficcd_mess_error_update_dir_wagon_db_ids': 'Error performing operation "UPDATE {0} IN IDS DIRECTORY", error code {1}',
            'ficcd_mess_warning_sap_no_select': 'Request for information on an inbound delivery created by SAP - was not completed, you can request it manually by clicking the button below or the request will be executed automatically for each wagon after the entire train is accepted.',
            'ficcd_mess_warning_sap_not_full': 'Incoming delivery information is not complete, the information is being completed, you can update the information by making a request manually.',
            'ficcd_mess_ok_sap_full': 'Incoming delivery info is full, row closed.',
            'ficcd_mess_run_operation_arrival_wagon': 'Running operation "ACCEPT CAR {0} TO AMCR"...',
            'ficcd_mess_run_operation_searsh_main_doc': 'Running operation "SEARCH MAIN EPD {0} BY CAR {1} "...',
            'ficcd_mess_run_operation_searsh_doc_of_num_dt': 'Performing the operation "SEARCH EPD BY CAR {0} ARRIVAL {1} "...',
            'ficcd_mess_run_operation_change_mode_epd': 'EPD mode change...',
            'ficcd_mess_run_operation_change_mode_return': 'Return wagon...',
            'ficcd_mess_ok_operation_arrival_wagon': 'Operation "ACCEPT THE {0} WAGON TO AMKR" - Done',
            'ficcd_mess_error_arrival_wagon': 'Error performing operation "ACCEPT WAGON {0} TO AMCR" - Error code: {1}',
            'ficcd_mess_run_operation_return_arrival_wagon': 'Performing operation "CANCEL ACCEPTING WAGON {0} TO AMCR"...',
            'ficcd_mess_ok_operation_return_arrival_wagon': 'Operation "CANCEL ACCEPTANCE OF WAGON {0} TO AMKR" - Done',
            'ficcd_mess_error_operation_return_arrival_wagon': 'Error performing operation "CANCEL ACCEPTANCE OF WAGON {0} TO AMCR" - Error code: {1}',
            'ficcd_mess_cancel_operation_return_arrival_wagon': 'Canceling the operation "CANCEL THE ACCEPTANCE OF THE CAR {0} ON AMKR"',

            'ficcd_mess_ok_operation_update_sap': 'UPDATE INCOMING DELIVERY operation completed',
            'ficcd_mess_error_operation_update_sap': 'Error performing operation "UPDATE INCOMING DELIVERY"',

            'ficcd_title_ext_station': 'EXTERNAL STATION',
            'ficcd_title_border_checkpoint': 'BORDER CROSS STATION',
            'ficcd_title_shipper': 'SHIPPER',
            'ficcd_title_card_wagon': 'CAR CARD',
            'ficcd_title_payer_sender': 'PAYER ON ARRIVAL',
            'ficcd_title_cargo_etsng': 'CARGO ET CIS',
            'ficcd_title_cargo_gng': 'GNG CARGO',
            'ficcd_title_not': 'no change',
            'ficcd_title_add': 'added',
            'ficcd_title_update': 'updated',
            'ficcd_title_uz_epd': 'from UZ and EPD database',
            'ficcd_title_uz': 'Uz DB only.',
            'ficcd_title_on_the_road': 'On the road',

            'fogcd_form_search_epd': 'Find EPD',
            'fogcd_form_search_car_uz_epd_message': 'If the EPD is not found in the IDS database, include the "UZ Client" system in the document search?. Attention! It may take several minutes to search for an EPD in the UZ Client system!',

            'fogcd_mess_warning_no_data_return_wagon': 'The specified wagon ID {0} has no data to send to the CID DB.',

            'ficcd_mess_valid_not_nom_main_doc': 'Specify invoice number',
            'ficcd_mess_valid_not_number_nom_main_doc': 'Invoice number must be numbers',
            'ficcd_mess_valid_nom_main_doc_manual_exist': 'Invoice exists, created {0} manually.',
            'ficcd_mess_valid_not_epd_main_doc': 'Main EPD - not found!',
            'ficcd_mess_valid_not_epd_doc': 'Sending EPD - not found!',
            'ficcd_mess_valid_epd_equal': 'Primary and forwarding invoice numbers are the same!',

            'ficcd_mess_valid_not_station_from_name': 'Specify a departure station',
            'ficcd_mess_valid_station_from_name': 'The specified departure station is not in the CID directory',
            'ficcd_mess_valid_add_station_from_name': 'Departure station not in CID directory, add station to directory to continue',
            'ficcd_mess_valid_not_station_on_name': 'Specify arrival station',
            'ficcd_mess_valid_station_on_name': 'The specified arrival station is not in the CID directory',
            'ficcd_mess_valid_add_station_on_name': 'Destination station not in CID directory, add station to directory to continue',
            'ficcd_mess_valid_add_stn_border_name': 'Border crossing station not in CID directory, add station to directory to continue',
            'ficcd_mess_valid_border_name': 'The specified border crossing station is not in the CID directory',
            'ficcd_mess_valid_not_stn_border_cross_time': 'Specify date and time of border crossing',
            'ficcd_mess_valid_add_shipper_name': 'Shipper not in CID directory, please add shipper to directory to continue',
            'ficcd_mess_valid_shipper_name': 'The specified shipper is not in the CID directory',
            'ficcd_mess_valid_not_shipper_name': 'Specify shipper',
            'ficcd_mess_valid_add_consignee_name': 'Consignee not in CID directory, contact administrator to add new consignee to CID directory',
            'ficcd_mess_valid_not_consignee_name': 'Specify consignee',
            'ficcd_mess_valid_not_station_amkr_name': 'Specify AMKR Station',
            'ficcd_mess_valid_add_division_name': 'The AMKR division is not in the IDS directory, contact the administrator to add a new AMKR division to the IDS directory',
            'ficcd_mess_valid_division_name': 'The AMKR division is not in the IDS directory',
            'ficcd_mess_valid_not_division_name': 'Specify AMC Division',
            'ficcd_mess_valid_add_name_adm': 'Administration not in CID directory, contact administrator to add new administration to CID directory',
            'ficcd_mess_valid_not_name_adm': 'Specify an administration',
            'ficcd_mess_valid_add_rod_vag': 'The wagon type is not in the CID directory, contact the administrator to add a new kind to the CID directory',
            'ficcd_mess_valid_not_rod_vag': 'Specify wagon type',
            'ficcd_mess_valid_add_name_owner': 'The wagon owner is not in the CID directory, please contact the administrator to add a new owner to the CID directory',
            'ficcd_mess_valid_not_name_owner': 'Specify Owner',
            'ficcd_mess_valid_add_type_ownership': 'Wagon ownership type is not in the CID directory, please contact the administrator to add a new type to the CID directory',
            'ficcd_mess_valid_add_adm_name_plat': 'Payer for the shipment is not in the IDS directory, contact the administrator to add a new payer to the IDS directory',
            'ficcd_mess_valid_add_name_plat': 'Payer for the shipment is not in the CID directory, to continue, add a new payer to the CID directory',
            'ficcd_mess_valid_name_plat': 'Payer for the shipment is not in the IDS directory',
            'ficcd_mess_valid_not_name_plat': 'Specify payer for sending',
            'ficcd_mess_valid_add_adm_name_etsng': 'ET CIS cargo is not in the CID directory, contact the administrator to add a new cargo to the CID directory',
            'ficcd_mess_valid_add_name_etsng': 'ET CIS cargo not in CID directory, add new cargo to CID directory to continue',
            'ficcd_mess_valid_name_etsng': 'ET CIS cargo not in CID directory.',
            'ficcd_mess_valid_not_name_etsng': 'Specify ET CIS cargo',
            'ficcd_mess_valid_add_adm_name_gng': 'Gng cargo is not in the CID directory, please contact the administrator to add a new cargo to the CID directory',
            'ficcd_mess_valid_add_name_gng': 'Gng cargo not in CID directory, please add new cargo to CID directory to continue',
            'ficcd_mess_valid_not_name_gng': 'Specify a GNG cargo',
            'ficcd_mess_valid_not_condition_arrival': 'Specify arrival markup',
            'ficcd_mess_valid_range_gruzp': 'Cargo capacity must be between {0} and {1} tons.',
            'ficcd_mess_valid_range_ves_tary': 'Tare must be between {0} and {1} tons.',
            'ficcd_mess_valid_not_group_cargo': 'Cargo undefined',
            'ficcd_mess_valid_nom_vesg': 'Enter weight of cargo',
            'ficcd_mess_valid_not_distance_way': 'No fare distance specified',
            'figcd_mess_valid_not_deff_date_detention': 'The date and time of receipt according to the act cannot be less than the arrival time of the train {0} or more than {1} min. from current date',

            'ficcd_mess_valid_error_num': 'The specified wagon {0} has already been moved, position #{1}',
            'ficcd_mess_valid_error_position1': 'First presented wagon must start at position 1',
            'ficcd_mess_valid_error_position2': 'The specified position {0} already exists, wagon #{1}',

            'ficcd_mess_warning_no_data_wagon_uz': 'There is no data in the DB for the selected wagon. (data from the IDS reference will be applied).', //
            'ficcd_mess_warning_off_data_wagon_uz': 'Warning! Request to the DB UZ - disabled! (data from the IDS reference will be applied).', //
            'ficcd_mess_warning_no_data_wagon_ids': 'There is no data for the selected wagon in the IDS DB.', //

            'ficcd_message_mode_manual': 'Warning! Document #{0} was entered manually!',
            'ficcd_message_mode_return': 'Warning! The car is returnable. Document #{0} was taken from the last submission!',
            'ficcd_message_mode_auto_manual': 'Warning! Document #{0} was entered manually in the "no document" mode!',
            'ficcd_message_mode_null': 'Warning! The mode "Water of information without the consignment note" is selected. The invoice number will be generated automatically, the card is switched to manual entry mode.',
            'ficcd_message_mode_1': 'Warning! EPD is not defined for the specified wagon, to continue, select one of the two modes: 1-"Entering information without a consignment note" (Select the checkbox "Without EPD"); 2-“Search EPD by wagon number and arrival date” (Press the search button next to the wagon number) .',
            'ficcd_message_mode_2': 'Warning! The main EPD is not defined for the specified wagon. To continue, click the EPD search button next to the main invoice number field. (The EPD will be searched by wagon number and consignment note number)',
            'ficcd_message_mode_3': 'Warning! It was not possible to find the main EPD for the specified car, the card was switched to manual entry mode, enter the missing information into manual mode.',
            'ficcd_message_mode_4': 'Warning! The main EPD is not defined for the specified wagon, to continue select one of the two modes: 1-"Entering information without a consignment note" (Select the checkbox "Without EPD"); 2-"Search for EPD by wagon number and invoice number" (Enter the invoice number and press the search button)',
            'ficcd_message_mode_5': 'Warning! It was not possible to find an EPD for the specified car, the card was switched to manual entry mode, to continue select one of the two modes: 1-"Entering information without a consignment note" (Select the checkbox "Without EPD"); 2-“Full manual entry” (Invoice numbers and characteristics are entered manually).',
            'ficcd_message_mode_6': 'Warning! The main document was found for the specified car, but the forwarding document was not defined, the card was switched to manual entry mode, enter the missing information on the forwarding document into manual mode.',
            'ficcd_message_mode_7': 'Warning! For the specified wagon, the EPD of the previous departure to the UZ will be indicated, the card is switched to manual entry mode, enter the missing information into manual.',

            'ficcd_mess_warning_no_epd_wagon': 'There is no shipping document for the selected wagon.', //
            'ficcd_mess_warning_no_main_epd_wagon': 'There is no EPD for the selected wagon.', //
            'ficcd_mess_error_wagon_arrival': 'Wagon {0} - not accepted: {1} or status {2} is not equal to 1', //

            'ficcd_mess_init_panel': 'Module initialization (form_incoming_cars_detali) ...',
            'ficcd_mess_load_wagon': 'Updating wagon info...', //
            'ficcd_mess_update_wagon': 'Updating the information on the wagon in the IDS database according to the EPD data', //
            'ficcd_mess_error_update_wagon': 'Error updating wagon information in the IDS DB, error code: {0}', //
            'ficcd_mess_load_db_uz': 'Updating wagon info from UZ DB...', //
            'ficcd_mess_update_sap': 'Updating information on an incoming delivery', //
        }
    };
        ...
        this.load_db(['hazard_class', 'certification_data', 'commercial_condition', 'cargo', 'cargo_group', 'cargo_gng', 'cargo_etsng', 'external_station', 'border_checkpoint', 'shipper', 'consignee', 'station', 'divisions', 'countrys', 'genus_wagon', 'condition_arrival', 'type_wagons', 'owners_wagons', 'type_owner_ship', 'operators_wagons', 'limiting_loading', 'payer_sender'], false, function (result) {
            ...
            var form_checkbox_return = {
                ...
                options: {
                    ...
                    form_group_col: 12,
                    form_group_class: 'text-left',
                    label: langView('fogcd_label_return', App.Langs),
                    label_class: 'mb-1',
                    checkbox_class: 'inp-manual',
                    checkbox_title: null,
                    checkbox_required: null,
                    ...
                    element_change: function (e) {
                        ...
                        if (res) {
                            if (this.wagon) {
                                this.wagon_buffer = $.extend({}, this.wagon);
                                this.get_return_wagon(function (wagon_outgoing) {
                                    if (wagon_outgoing !== null) {
                                        //
                                        this.ids_wsd.getOTPR_UZ_DOC_OUTOfNum(wagon_outgoing.outgoing_car_num_doc, function (otpr) {
                                            if (otpr === null) {
                                                // Иногда нет данных, сообщаем!
                                                this.out_warning(langView('ficcd_mess_warning_no_epd_wagon', App.Langs));
                                                this.wagon_settings.return_main_otpr_num = null;
                                                this.wagon_settings.return_main_otpr_id = null;
                                                this.wagon_settings.return_main_otpr = null;

                                            } else {
                                                this.wagon_settings.return_main_otpr_num = otpr.nom_doc;
                                                this.wagon_settings.return_main_otpr_id = wagon_outgoing.outgoing_car_num_doc;
                                                this.wagon_settings.return_main_otpr = otpr;
                                            }

                                            this.wagon.arrival_uz_document_nom_main_doc = this.wagon_settings.return_main_otpr_num;
                                            this.wagon.arrival_uz_document_code_stn_from = wagon_outgoing.outgoing_uz_document_code_stn_from;
                                            this.wagon.arrival_uz_document_code_stn_to = wagon_outgoing.outgoing_uz_document_code_stn_from;
                                            this.wagon.arrival_uz_document_code_shipper = wagon_outgoing.outgoing_uz_document_code_shipper;
                                            this.wagon.arrival_uz_document_code_consignee = wagon_outgoing.outgoing_uz_document_code_shipper;

                                            this.wagon.arrival_uz_vagon_gruzp = wagon_outgoing.outgoing_uz_vagon_gruzp;
                                            this.wagon.arrival_uz_vagon_u_tara = wagon_outgoing.outgoing_uz_vagon_u_tara;
                                            this.wagon.arrival_uz_vagon_ves_tary_arc = wagon_outgoing.outgoing_uz_vagon_ves_tary_arc;

                                            this.wagon.arrival_uz_vagon_cargo_etsng_code = wagon_outgoing.outgoing_uz_vagon_cargo_etsng_code;
                                            this.wagon.arrival_uz_vagon_cargo_gng_code = wagon_outgoing.outgoing_uz_vagon_cargo_gng_code;
                                            this.wagon.arrival_uz_vagon_vesg = wagon_outgoing.outgoing_uz_vagon_vesg;

                                            this.mode_epd_buffer = this.mode_epd;
                                            this.mode_epd = 7;
                                            this.view_wagon_detali(this.wagon)
                                        }.bind(this));
                                    }
                            ...
                            this.wagon_settings.return_main_otpr_id = null;
                            this.wagon_settings.return_main_otpr = null;
                            this.mode_epd = this.mode_epd_buffer;
                            this.wagon = $.extend({}, this.wagon_buffer);
                            this.view_wagon_detali(this.wagon)
                        }
                    }.bind(this),
                },
            ...
            col_checkbox.childs.push(form_checkbox_not_epd);
            col_checkbox.childs.push(form_checkbox_return);

            form_row_common3.childs.push(col_checkbox);
    ...
    form_incoming_cars_detali.prototype.wagon_detali = function (id, options) {
        ...
        this.wagon_settings = $.extend({
            ...
            dir_wagon_mode: 0,              // 
            return_main_otpr_num: null,    // ЭПД - № основного документа
            return_main_otpr: null,        // ЭПД - основного документа
            return_main_otpr_id: null,      // ЭПД - код УЗ основного документа
        ...
        this.elements.checkbox_not_epd.val(false);
        this.elements.checkbox_return.val(false);
    ...
    form_incoming_cars_detali.prototype.view_wagon_detali = function (wagon) {
        if (this.wagon_settings) {
            ...
            var id_outgoing_car = wagon.arrival_car_id_outgoing_car;
            var id_outgoing_uz_vagon = wagon.arrival_car_id_outgoing_uz_vagon;
            var cargo_returns = wagon.arrival_uz_vagon_cargo_returns;
            // Настроем отображение если окно в режиме редактирования
            this.form.validation_epd.clear_all();
            if (this.wagon_settings.type === 0) {
                this.elements.checkbox_return.val(cargo_returns);
                if (nom_main_doc < 0) {
                    ...
                    if (document_manual) {
                        if (cargo_returns) {
                            this.form.validation_epd.out_warning_message(langView('ficcd_message_mode_return', App.Langs).format(nom_doc !== null ? nom_doc : nom_main_doc));
                        } else {
            ...
            if (this.wagon_settings.type === 1) {
                if (this.elements.checkbox_not_epd.val() === true) {
                    ...
                    this.elements.checkbox_return.val(false);
                    this.elements.checkbox_return.disable();
                    this.elements.button_search_car.hide();
                    this.elements.button_search_main_doc.hide();
                    this.elements.button_change_main_doc.hide();
                    this.elements.button_search_doc.hide();
                    ...
                    switch (this.mode_epd) {
                        ...
                        case 7: {
                            nom_main_doc = this.wagon_settings.return_main_otpr_num; //this.epd.nom_main_doc;
                            // Вагон возвратный
                            this.edit(); // режим ручной ЭПД
                            this.elements.checkbox_not_epd.disable();
                            //this.elements.checkbox_not_epd.val(false);
                            ...
                            this.elements.button_search_doc.hide();
                            this.elements.button_change_doc.hide();
                            if (nom_main_doc !== null) this.elements.input_text_document_nom_main_doc.disable(); else this.elements.input_text_document_nom_main_doc.enable();
                            this.elements.input_text_document_nom_doc.disable();
                            this.form.validation_epd.out_warning_message(langView('ficcd_message_mode_7', App.Langs));
                            break;
                        };
                    }
                    if (id_outgoing_uz_vagon !== null) {
                        this.elements.checkbox_return.enable();
                    } else {
                        this.elements.checkbox_return.disable();
                    }
                }
    ...
    form_incoming_cars_detali.prototype.view_wagon_detali_consignee = function () {
        if (this.wagon && this.wagon_settings) {
            ...
            var name = this.wagon.arrival_uz_document_name_consignee;
            // Настроем отображение если окно в режиме редактирования
            if (this.wagon_settings.type === 1) {
                // Прочесть текущее
    ...
    // Найти документы по возврату
    form_incoming_cars_detali.prototype.get_return_wagon = function (callback) {
        if (this.wagon && this.wagon.arrival_car_id_outgoing_car) {
            LockScreen(langView('ficcd_mess_run_operation_change_mode_return', App.Langs));
            this.ids_wsd.getViewOutgoingCarsOfIDCar(this.wagon.arrival_car_id_outgoing_car, function (wagon_outgoing) {
                if (wagon_outgoing) {
                    this.wagon_outgoing = wagon_outgoing;
                    //LockScreenOff();
                    if (typeof callback === 'function') {
                        callback(this.wagon_outgoing);
                    }
                } else {
                    this.wagon_outgoing = null;
                    this.out_error(langView('fogcd_mess_warning_no_data_return_wagon', App.Langs).format(this.wagon.arrival_car_id_outgoing_car));
                    //LockScreenOff();
                    if (typeof callback === 'function') {
                        callback(this.wagon_outgoing);
                    }
                    ...
                    if (valid) {
                        ...
                        if (this.elements.checkbox_not_epd.val() === false) {
                            switch (this.mode_epd) {
                                ...
                                case 7: {
                                    this.wagon_settings.return_main_otpr_num = Number(this.elements.input_text_document_nom_main_doc.val());
                                    mode = 4;
                                    break;
                                };
                        ...
                        var arrival_main_doc = {
                            id_doc: mode === 4 ? this.wagon_settings.return_main_otpr_id : this.wagon_settings.main_otpr_id,
                            nom_doc: mode === 4 ? this.wagon_settings.return_main_otpr_num : this.wagon_settings.main_otpr_num,
                        ...
                        var arrival_vagon_main_doc = {
                            ...
                            vesg: vesg ? Number(Number(vesg * 1000).toFixed(0)) : null,
                            vesg_reweighing: vesg_reweighing ? Number(Number(vesg_reweighing * 1000).toFixed(0)) : null,
                            ...
                            cargo_returns: mode === 4 ? true : null,
                            ...
                            pay_summa: pay_summa ? Number(Number(pay_summa * 100).toFixed(0)) : null,
