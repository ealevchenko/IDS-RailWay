(function (window) {
    ...
    $.Text_View =
    {
        ...
        {
            'tcow_field_from_id_wim': 'disl. id send. ',
            'tcow_field_id_wir': 'id ext. perm. ',
            'tcow_field_from_id_wio': 'opera id send. ',
            'tcow_field_on_id_wim': 'disl. id arr. ',
            'tcow_field_on_id_wio': 'opera id arr. ',
            'tcow_field_outer_way_num_sostav': 'Squad #',
            'tcow_field_num': 'Wag. no.',
            'tcow_field_position': 'Pos. no.',
            'tcow_field_arrival_nom_main_doc': 'tilt no. by arr. ',
            'tcow_field_arrival_nom_doc': 'Dos no. by arr. ',
            'tcow_field_wagon_adm': 'Admin code',
            'tcow_field_wagon_adm_name': 'Administration',
            'tcow_field_wagon_adm_abbr': 'Admin.',
            'tcow_field_wagon_rod': 'Rod of wagon.',
            'tcow_field_wagon_rod_name': 'Rod of wagon.',
            'tcow_field_wagon_rod_abbr': 'Gender of wagon (abbr.)',
            'tcow_field_id_operator': 'opera id',
            'tcow_field_operators': 'Operator',
            'tcow_field_operator_abbr': 'Operator (abbr.)',
            'tcow_field_operator_rent_start': 'Start. lease ',
            'tcow_field_operator_rent_end': 'End. lease ',
            'tcow_field_operator_paid': 'Prize. paid ',
            'tcow_field_id_limiting_loading': 'limiting id',
            'tcow_field_limiting_name': 'Limit',
            'tcow_field_limiting_abbr': 'Limiting. (abbr.) ',
            'tcow_field_arrival_condition_name': 'Arrival (arrivals)',
            'tcow_field_arrival_condition_abbr': 'Size',
            'tcow_field_arrival_condition_red': 'red',
            'tcow_field_arrival_cargo_group_name': 'Arrival Cargo Group',
            'tcow_field_arrival_cargo_name': 'Cargo upon arrival',
            'tcow_field_arrival_id_sertification_data': 'ser. id Dan.',
            'tcow_field_arrival_sertification_data': 'Certification data',
            'tcow_field_arrival_division_amkr_code': 'Shop code',
            'tcow_field_arrival_division_amkr_name': 'Shop received',
            'tcow_field_arrival_division_amkr_abbr': 'Shop received',
            'tcow_field_id_arrival_car': 'arrivals id vag. ',
            'tcow_field_id_sap_incoming_supply': 'id in. fast.',
            'tcow_field_doc_outgoing_car': 'Cash. doc. for passing on ultrasound ',
            'tcow_field_id_outgoing_car': 'otp id vag. ',
            'tcow_field_id_sap_outbound_supply': 'id ref. fast.',
            'tcow_field_wir_note': 'Note',
            'tcow_field_wir_create': 'Int. perm. created',
            'tcow_field_wir_create_user': 'Int. perm. created ',
            'tcow_field_wir_close': 'Int. perm. closed',
            'tcow_field_wir_close_user': 'Int. perm. closed ',
            // Arrival operation
            'tcow_field_from_id_operation': 'opera id',
            'tcow_field_from_operation_name': 'Sending operation',
            'tcow_field_from_operation_start': 'Start. opera. send. ',
            'tcow_field_from_operation_end': 'End. opera. send. ',
            'tcow_field_from_busy': 'Busy (operation)',
            'tcow_field_from_operation_locomotive1': 'Loc. # 1',
            'tcow_field_from_operation_locomotive2': 'Loc. # 2',
            'tcow_field_from_operation_note': 'Opera. note',
            'tcow_field_from_operation_create': 'Opera. send created ',
            'tcow_field_from_operation_create_user': 'Issue. opera. sent. ',
            'tcow_field_from_operation_close': 'Opera. send closed ',
            'tcow_field_from_operation_close_user': 'Close. opera. sent. ',
            'tcow_field_from_operation_parent_id': 'id prev. opera. ',
            //
            'tcow_field_from_operation_id_condition': 'id Size send. ',
            'tcow_field_from_operation_condition_name': 'Markup (send)',
            'tcow_field_from_operation_condition_abbr': 'Size send (abbr.) ',
            'tcow_field_from_operation_id_loading_status': ' state id download send. ',
            'tcow_field_from_operation_loading_status': 'Upload status on upload',
            //
            'tcow_field_from_id_station': 'id st. send. ',
            'tcow_field_from_station_name': 'Departure station',
            'tcow_field_from_station_abbr': 'Art. send (abbr.) ',
            'tcow_field_from_id_way': 'send id path',
            'tcow_field_from_id_park': 'park id sent.',
            'tcow_field_from_way_name': 'Submission path',
            'tcow_field_from_way_abbr': 'Send path (abbr.) ',
            'tcow_field_from_way_capacity': 'Send path (together) ',
            'tcow_field_from_way_close': 'Send path closed ',
            'tcow_field_from_way_delete': 'Send path deleted ',
            'tcow_field_from_way_note': 'Send path note ',
            'tcow_field_from_way_start': 'Send path vag. arr. ',
            'tcow_field_from_way_end': 'Send path vag. departed. ',
            'tcow_field_id_outer_way': 'field id',
            'tcow_field_name_outer_way': 'Ferry',
            'tcow_field_outer_way_close': 'Recur. closed ',
            'tcow_field_outer_way_delete': 'Pereg. deleted ',
            'tcow_field_outer_way_note': 'Ferry approx.',
            'tcow_field_outer_way_start': 'Driving wagons. fast.',
            'tcow_field_outer_way_end': 'Ferry. vag. removed. ',
            'tcow_field_from_wim_note': 'Dist. send note',
            'tcow_field_from_wim_create': 'Dist. send created ',
            'tcow_field_from_wim_create_user': 'Dist. send created ',
            'tcow_field_from_wim_close': 'Dist. send closed ',
            'tcow_field_from_wim_close_user': 'Dist. send closed ',
            'tcow_field_from_wim_parent_id': 'send id disloc. ',
            ...
            'tcow_field_on_way_abbr': 'Arrival path (abbr.) ',
            'tcow_field_on_way_capacity': 'Path of arr. (together) ',
            'tcow_field_on_way_close': 'Arrival path closed ',
            'tcow_field_on_way_delete': 'Arrival path deleted ',
            'tcow_field_on_way_note': 'Arr path note ',
            'tcow_field_on_way_start': 'Dist. approx. vag. arr. ',
            'tcow_field_on_way_end': 'Disl arr. vag. departed. ',
            'tcow_field_on_way_position': 'Dist. approx. Item no. ',
            'tcow_field_on_wim_note': 'Dist. approx. note',
            'tcow_field_on_wim_create': 'Dist. approx. created ',
            'tcow_field_on_wim_create_user': 'Dist. approx. created ',
            'tcow_field_on_wim_close': 'Dist. approx. closed ',
            'tcow_field_on_wim_close_user': 'Dist. approx. closed ',
            'tcow_field_on_wim_parent_id': 'id prev. disloc. ',
            //
            'tcow_field_on_id_operation': 'opera id',
            'tcow_field_on_operation_name': 'Sending operation',
            'tcow_field_on_operation_start': 'Start. opera. arr. ',
            'tcow_field_on_operation_end': 'End. opera. arr. ',
            'tcow_field_on_busy': 'Busy (operation)',
            'tcow_field_on_operation_locomotive1': 'Loc. # 1',
            'tcow_field_on_operation_locomotive2': 'Loc. # 2',
            'tcow_field_on_operation_note': 'Opera. note',
            'tcow_field_on_operation_create': 'Opera. approx. created ',
            'tcow_field_on_operation_create_user': 'Issue opera. arr. ',
            'tcow_field_on_operation_close': 'Opera. send closed ',
            'tcow_field_on_operation_close_user': 'Close. opera. sent. ',
            'tcow_field_on_operation_parent_id': 'id prev. opera. ',
            //
            'tcow_field_on_operation_id_condition': 'id Size reception. ',
            'tcow_field_on_operation_condition_name': 'Markup (receive)',
            'tcow_field_on_operation_condition_abbr': 'Size reception (abbr.) ',
            'tcow_field_on_operation_id_loading_status': ' state id download reception. ',
            ...
            'tcow_title_button_tcow_field_clear': 'Reset',
            ...
            'tcow_mess_view_wagons': 'loading information about wagons of the train ...',
            'tcow_mess_view_sostav': 'loading information about trains on the stretch ...',
        }
    };
