...
(function (window) {
    ...
    $.Text_View =
    {
        ...
        'en':  //default language: English
        {
            ...
            'fhiis_title_label_num_doc': 'Document#:',
            'fhiis_title_placeholder_num_doc': 'Document#',
            ...
            'fhiis_title_label_date_adoption': 'Date and time of admission:',
            'fhiis_title_placeholder_date_adoption': 'Adoption Time',
            'fhiis_title_label_date_adoption_act': 'Date and time of admission (act):',
            'fhiis_title_placeholder_date_adoption_act': 'Adoption time (act)',
            'fhiis_title_label_station_from': 'Arrived from station:',
            'fhiis_title_placeholder_station_from': 'Arrival Station:',
            'fhiis_title_label_station_on': 'Accept to station:',
            'fhiis_title_placeholder_station_on': 'Accept to station:',
            'fhiis_title_label_way': 'Take to path:',
            'fhiis_title_placeholder_way': 'Take to path:',
            'fhiis_title_label_numeration': 'Numbering starts from:',
            'fhiis_title_placeholder_numeration': 'Accept on path:',
            'fhiis_title_head': 'Head',
            'fhiis_title_tail': 'Tail',
            ...
            'fhiis_title_form_arrival': 'Accept composition',
            ...
            'fhiis_error_date_arrival_not_deff_date_adoption_act': 'The date and time of arrival according to the act must be at least {0} min. or more {1} min. from the time of admission.',
