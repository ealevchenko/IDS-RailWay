jQuery(document).ready(function ($) {
    ...
    $.Text_View =
    {
        ...
        'en':  //default language: English
        {
            ...
            'field_count_all': 'Accepted-Wagons left',
            'field_status': 'Status',
            ...
            'field_doc_id': 'Document identifier at the base of AT "Ukrzaliznytsia"',
            'field_description': 'Document Description',
            'field_doc_date': 'Document date',
            'field_doc_type': 'Code for the type of the parent document',
            'field_doc_type_name': 'Naming the type of the supervid document',
            'field_kod_zd_use': 'Code for the validity of the document',
            'field_kol': 'Number of copies',
            ...
            'field_epd_nom_doc': 'Epd no.',
            'field_epd_id_doc': 'doc-id',
            ...
            'field_commercial_condition': 'Com. state',
                    ...
                    if (select_nums && select_nums.length > 0) {
                        ...
                        select_nums.forEach(function (item, index, array) {
                            ...
                            if (wag) {
                                ...
                                mywindow.document.write('<p class=MsoNormal class="p-text-title"><b><span class="text-title">Дата приема </span></b><span style="color:black" class="text-title"><i>' + getReplaceTOfDT(sostav.date_adoption) + '</i></span></p>');
                                mywindow.document.write('</td>');
                                mywindow.document.write('</tr>');
                                //
                                mywindow.document.write('<tr>');
