(function ($) {
    ...
    //// Модуль "Таблица справочника операторов вагонов"
    var TDOW = App.table_dir_operators_wagons;
    var tdow = new TDOW('div#operators-wagons'); // Создадим экземпляр таблицы
    ...
    $(document).ready(function ($) {
        ...
        load_db(['operators_wagons'], true, function (result) {
            // Инициализация модуля  "Таблица справочника операторов вагонов"
            tdow.init({
                alert: alert,
                ids_dir: ids_dir,
            }, function () {
