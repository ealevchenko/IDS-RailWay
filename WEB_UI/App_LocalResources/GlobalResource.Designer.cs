...
namespace WEB_UI.App_LocalResources {
    ...
    public class GlobalResource {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на «Железнодорожный транспорт АМКР» - внутренняя диспетчерская система оперативного управления перевозочным процессом на железнодорожном транспорте  внутри предприятия ПАО «АРСЕЛОРМИТТАЛ КРИВОЙ РОГ».
        /// </summary>
